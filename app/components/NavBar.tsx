...
import NotificationPopover from './elements/NotificationsPopover';
import ProfileMenuMobile from './elements/ProfileMenuMobile';
...
const Navbar = () => {
    ...
    const notifications = [
        ...
        { title: 'Referal Bonus arrived! 🎁', text: 'Consectetur adipiscing elit.' },
        ...
        <header className="bg-background w-full py-2 lg:py-4  px-6 border-b border-gray-200 bg-gray-50 dark:bg-slate-950 dark:border-gray-700 absolute mx-auto z-50 ">
            <div className="flex items-center justify-between mx-auto w-full">
                <span className='flex items-center gap-4'>
                    ...
                    <h1 className="text-lg md:text-xl sm:text-xl font-semibold md:block">Dashboard</h1>
                </span>
                ...
                <div className="hidden md:flex items-center space-x-4">
                    <div className='flex items-center space-x-3'>
                        <div className="relative">
                            ...
                            <svg className="w-4 h-4 text-gray-500 dark:text-gray-400" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                            ...
                            <input type="search" id="default-search" className="outline-none  block w-full p-4  py-3 pl-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-full bg-transparent focus:ring-green-500 focus:border-green-500  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500 bg-transparent" placeholder="Search..." required />
                        </div>
                    </div>
                    <div className="flex items-center space-x-3">
                        ...
                        <span className="text-sm dark:text-gray-300">{formattedDate}</span>
                    </div>
                    <NotificationPopover
                            buttonContent={
                    ...
                    <div className='text-gray-500 dark:text-gray-400'>
                         <ProfileMenu name="chukwuma samuel" email="chukwumasam@gmail.com">
                             <Image className="w-8 h-8"src={Avatar} alt="Avatar" />
                        </ProfileMenu>
                    </div>
                </div>
            ...
            <Transition show={menuOpen}>
                <div className="md:hidden fixed inset-0 bg-black bg-opacity-50 z-50" onClick={() => setMenuOpen(false)}></div>
                <div className="md:hidden fixed inset-y-0 right-0 w-64 bg-white dark:bg-gray-800 shadow-lg z-50">
            ...
            <div className="px-4 space-y-5">
                <div className='flex items-center space-x-3'>
                    <div className="relative">
                        ...
                        <input type="search" id="default-search" className="outline-none block w-full p-4 py-3 pl-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-full bg-gray-50 focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500" placeholder="Search..." required />
                    </div>
                </div>
